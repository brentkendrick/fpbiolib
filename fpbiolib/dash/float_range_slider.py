...
#         input_value = input_value if trigger_id == f'{slider_id}-input' else slider_str_value
#         slider_value = slider_value if trigger_id == f'{slider_id}' else float(input_value)
