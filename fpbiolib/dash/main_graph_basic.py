...
from ..df_transforms import df_trunc, df_min_max_norm, df_area_norm
from ..custom_plots import primary_graph, baseline_check_graph
...
def main_graph(
    ...
    @app.callback(
        ...
        # Input('trace_chkbox_deriv', 'value'),
        # Input('window', 'value'),
        Input("baseline_dropdown", "value"),
        # Input('asym_baseline_modal', 'is_open'),
    ...
    def callback_main_graph(
        ...
        if not baseline_option == "complex":
            ...
            trace_viewer_parameters["lam interval:"] = lam_interval
