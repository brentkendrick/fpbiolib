...
def input_group_y(id):
    dropdown_menu_items = [
        ...
        dbc.DropdownMenuItem("Abs w/units", id=f"{id}-dropdown-menu-item-2"),
        dbc.DropdownMenuItem("2nd Der", id=f"{id}-dropdown-menu-item-3"),
        dbc.DropdownMenuItem("2nd Der w/units", id=f"{id}-dropdown-menu-item-4"),
...
def y_axis_dropdown_input_ctl(app, id):
    @app.callback(
        Output(id, "value"),
        [
    ...
    def on_button_click(n1, n2, n3, n4, n_clear):
